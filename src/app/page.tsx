    ...
    <>
        ...
        <div className="container">
          ...
          <div className="product-grid">
            <div className="product-card">
              <div className="product-image bg-purple-light">
                <span className="number-purple">01</span>
              </div>
            ...
            <div className="product-card">
              <div className="product-image bg-green-light">
                <span className="number-green">02</span>
              </div>
            ...
            <div className="product-card">
              <div className="product-image bg-purple-light">
                <span className="number-purple">03</span>
              </div>
              <h4>Impresion 3D</h4>
            ...
            <div className="product-card">
              <div className="product-image bg-green-light">
                <span className="number-green">04</span>
              </div>
      ...
      <section className="trending-section" id="contacto">
        <div className="container">
          <div className="trending-header">
            <h3>Contactanos</h3>
            <span className="text-green">Respondemos en 24hs</span>
          </div>
          ...
          <div className="features-grid">
            ...
            <a 
              ...
              className="product-card hover-lift feature-card"
            >
              <svg width="48" height="48" viewBox="0 0 24 24" fill="#10B981" className="icon-mb">
              ...
              <h4>WhatsApp</h4>
              <p className="text-muted">+598 91 037 258</p>
            </a>
            ...
            <a 
              ...
              className="product-card hover-lift feature-card"
            >
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#7C3AED" strokeWidth="2" className="icon-mb">
                <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                <polyline points="22,6 12,13 2,6"></polyline>
              </svg>
              <h4>Email</h4>
              <p className="text-muted">dimpura3d@gmail.com</p>
            </a>
            ...
            <a 
              ...
              className="product-card hover-lift feature-card"
            >
              <svg width="48" height="48" viewBox="0 0 24 24" fill="#7C3AED" className="icon-mb">
              ...
              <h4>Instagram</h4>
              <p className="text-muted">@dimpura3d</p>
            </a>

            {/* Location */}
            <div 
              className="product-card feature-card"
            >
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#10B981" strokeWidth="2" className="icon-mb">
                <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path>
                <circle cx="12" cy="10" r="3"></circle>
              </svg>
              <h4>Taller</h4>
              <p className="text-muted">Ignacio Medina 3257, Montevideo</p>
            </div>
          </div>
        </div>
      </section>
